/*
  ...
  * 
 * Using 3 VL53L0X Laser Distance Sensors
 * 
 * 
...
// address we will assign for all 3 sensors
#define LOX1_ADDRESS 0x30
#define LOX2_ADDRESS 0x31
#define LOX3_ADDRESS 0x32
int sensor1, sensor2, sensor3;

// set the pins to shutdown for all 3 sensors
#define SHT_LOX1 4    // D4
#define SHT_LOX2 13   // D13
#define SHT_LOX3 14   // D14
...
void setup() {
  ...
  Serial.println("All three in reset mode...(pins are low)");
...
void loop() {
  ...
  read_three_sensors();//robojax.com code
  delay(100);
}